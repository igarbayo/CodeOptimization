...
$(OUTPUT_DIR)/sin_opt.s: test_sin_opt.c
	mkdir -p $(OUTPUT_DIR)
	$(CC) $(CFLAGS) -S test_sin_opt.c -o $(OUTPUT_DIR)/sin_opt.s

$(OUTPUT_DIR)/opt_old.s: test_opt_old.c
	mkdir -p $(OUTPUT_DIR)
	$(CC) $(CFLAGS) -S test_opt_old.c -o $(OUTPUT_DIR)/opt_old.s

$(OUTPUT_DIR)/opt_new.s: test_opt_new.c
	mkdir -p $(OUTPUT_DIR)
	$(CC) $(CFLAGS) -S test_opt_new.c -o $(OUTPUT_DIR)/opt_new.s
