# Leer los datos
datos_old <- read.table("C:/Users/Ignacio/Desktop/OneDrive/Cuarto/Segundo Cuatri/Compiladores/p2 optim/resultados/DIA_OPT_OLD.txt", header = TRUE)
datos_sin <- read.table("C:/Users/Ignacio/Desktop/OneDrive/Cuarto/Segundo Cuatri/Compiladores/p2 optim/resultados/DIA_SIN_OPT.txt", header = TRUE)
...
pdf("C:/Users/Ignacio/Desktop/OneDrive/Cuarto/Segundo Cuatri/Compiladores/p2 optim/graficas/DIA_tiempos.pdf", width = 7, height = 6)
...
# Añadir líneas verticales para min y max (como barras de error)
...
pdf("C:/Users/Ignacio/Desktop/OneDrive/Cuarto/Segundo Cuatri/Compiladores/p2 optim/graficas/DIA_speedup.pdf", width = 7, height = 6)
